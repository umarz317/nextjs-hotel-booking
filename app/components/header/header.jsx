    ...
    <header className={styles.header}>
      <Navbar expand="md" data-bs-theme="dark" className="py-0">
        <Container fluid="md" className="justify-content-between py-0">
          ...
          <ul
            className="collapse navbar-collapse navbar-nav col-md-4 order-2 order-md-0 gap-4 gap-md-5 my-3 my-md-0"
            id="navbarToggler"
          >
          ...
          <div className="col-md-4 text-center">
            <Link
              href="/"
              className={`${allison.className} navbar-brand d-inline-flex link-body-emphasis text-decoration-none py-0 mx-0 ${styles.navbarBrand}`}
            >
